...
; intToString: takes an integer in eax and converts it into a string of up to 7 bytes
; it stores the results in [intBuffer], and returns a pointer to the front of the
; actual string in eax.  It also returns the length of the string in ecx.
; params:
;	eax - what to print
intToString:
